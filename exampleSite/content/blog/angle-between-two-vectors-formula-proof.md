...
**Method 1: Cosine rule**\\begin{equation} \\mathrm{Using\\ the\\ cos\\ rule\\ for\\ Figure\\ 1:}\\\\\\left|OA\\right|^{2}+\\left|OB\\right|^{2}-2\\left|OA\\right|\\left|OB\\right|\\cos\\theta=\\left|AB\\right|^{2}\\\\\\left|OA\\right|^{2}+\\left|OB\\right|^{2}-\\left|AB\\right|^{2}=2\\left|OA\\right|\\left|OB\\right|\\cos\\theta\\ \[1\] \\\\ \\mathrm{Consider \\ the\\ LHS:} \\\\2\\left|OA\\right|\\left|OB\\right|\\cos\\theta\\ \\\\=w^{2}+y^{2}+x^{2}+z^{2}-\\left(x+z\\right)^{2}-\\left(w-y\\right)^{2}\\\\=w^{2}+y^{2}+x^{2}+z^{2}-\\left(x^{2}+2zx+z^{2}\\right)-\\left(w^{2}-2wy+z^{2}\\right)\\\\=2wy-2zx\\\\ \\therefore\\ \\mathrm{Equation\\ \[1\]\\ becomes: }\\  \\\\wy-zx=\\left|A\\right|\\left|B\\right|\\cos\\theta\\\\\\frac{\\left(wy-zx\\right)}{\\left|OA\\right|\\left|OB\\right|}=\\cos\\theta\\\\\\frac{a\\cdot b}{\\left|OA\\right|\\left|OB\\right|}=\\cos\\theta\\end{equation}
